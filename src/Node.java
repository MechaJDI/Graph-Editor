...
public interface Node extends Serializable, Cloneable
{
   ...
   */
   ...
   void setTheX( int newX );

   void setTheY( int newY );
   ...
   Object clone();
	...
	/** Returns whether this node equals n.
	@param n the node to which this node is compared.
	@return whether n equals this node.
	*/
